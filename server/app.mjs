    ...
    recommendations: [
      {
        ...
        priority: "High",
        actionType: "Upgrade",
        description: "Upgrade the investor dashboard to provide real-time architectural milestones, drone inspection videos, and escrow verification for the STEM & AI schools planned (none built yet) in Lusaka and the Copperbelt.",
      ...
      },
      {
        id: "rec-cert-stripe",
        category: "Curriculum & Educational Platform",
        title: "Connect Stripe / PayPal to the $5 Certificate Checkout",
        priority: "Strategic",
        actionType: "Upgrade",
        description:
          "The claim already runs through the Seedwel Certificate Incorporation registry in Firebase (pending_payment → paid → claimed) with a built-in demo card checkout plus admin-approved manual payments. Attach a live processor to charge real cards and auto-approve paid claims.",
        impact: "Turns the tuition-free certification program into self-funding revenue at $5 per graduate.",
        status: "Recommended",
      },
      {
      ...
      },
      {
        ...
        category: "Technical & Database Infrastructure",
        title: "Production: enable Firebase Email/Password, publish Firestore rules & seed the course DB",
        priority: "High",
        actionType: "Upgrade",
        description: "In the Firebase console (project seedwel-cbeb8) enable the Email/Password provider, create the management accounts, create a Cloud Firestore database and publish the repo's firestore.rules — then press 'Publish Curriculum to Firestore' in the Database Console tab so the course, roles and the $5 certificate registry run 100% on Firebase.",
